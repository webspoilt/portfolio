            ...
            <div className="hidden md:flex items-center gap-8">
              {['home', 'featured', 'all-projects', 'skills', 'contact'].map((section) => (
                <button
                  ...
                  className={`capitalize text-sm font-medium transition-all hover:text-purple-400 ${
            ...
            >
              {['home', 'featured', 'all-projects', 'skills', 'contact'].map((section) => (
                <button
                  ...
                  className={`capitalize text-sm font-medium transition-all hover:text-purple-400 block w-full text-left ${
                    activeSection === section ? 'text-purple-400' : 'text-slate-300'
                  }`}
                >
                  {section.replace('-', ' ')}
